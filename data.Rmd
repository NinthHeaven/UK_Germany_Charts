...
# test_tracks <- map(uk_2000_data$artist, get_artist_audio_features)
...
ger2000_data <- data.frame(matrix(unlist(ger2000_hits$Names), nrow=100, byrow=T),stringsAsFactors=FALSE)
...
ger2001_data <- data.frame(matrix(unlist(ger2001_hits$Names), nrow=100, byrow = T), stringsAsFactors = FALSE)
...
ger2002_data <- data.frame(matrix(unlist(ger2002_hits$Names), nrow=100,
...
ger2003_data <- data.frame(matrix(unlist(ger2003_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
ger2004_data <- data.frame(matrix(unlist(ger2004_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
ger2005_data <- data.frame(matrix(unlist(ger2005_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
ger2006_data <- data.frame(matrix(unlist(ger2006_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
ger2007_data <- data.frame(matrix(unlist(ger2007_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
ger2008_data <- data.frame(matrix(unlist(ger2008_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
ger2009_data <- data.frame(matrix(unlist(ger2009_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
ger2010_data <- data.frame(matrix(unlist(ger2010_hits$Names), nrow=100,
                                  byrow = T), stringsAsFactors = FALSE)
...
# Demoing the graphs feature for further use
danceability_uk_2000_test <- testing %>%
  ggplot(aes(danceability)) +
  geom_density(fill = "#faac0f", colour = "#fcab08") +
