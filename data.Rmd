...
write_rds(uk_charts_listing, "raw-data/uk_charts_listing.rds")
write_rds(ger_charts_listing, "raw-data/ger_charts_listing.rds")

testttt <- read_rds("raw-data/ger_charts_listing.rds")
...
write_rds(yearly_uk_genres, "yearly_uk_genres.rds")
