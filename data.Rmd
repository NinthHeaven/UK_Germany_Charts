...
testing <- map(top_200_2020_uk$track_name, ~ get_track_audio_features)
...
ger2000_hits <- data.frame(matrix(unlist(ger2000_hits$Names), nrow=100, byrow=T),stringsAsFactors=FALSE)
